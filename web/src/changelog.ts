...
export const RELEASES: Release[] = [
  {
    ...
    notes: [
      ...
      'Your OpenMasjidOS inbox is ticked for all of them but one, and the email and WhatsApp boxes start empty. **The exception is “a donation is received”, which starts switched off on purpose** — it is the only one that happens every single time somebody gives, and switching it on for you would have meant hundreds of emails during a Ramadan appeal, with the message that actually needs you (“nobody can give right now”) stuck in the queue behind them. Tick it whenever you want it, and set a smallest amount beside it if a busy Friday would be too much.',
