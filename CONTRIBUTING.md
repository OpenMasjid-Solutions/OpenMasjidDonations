...
- Don't weaken the security invariants noted in the code (Stripe secret handling, webhook
  signature verification, Fabric SSRF guards, base-path/`X-Forwarded-Proto` handling).
